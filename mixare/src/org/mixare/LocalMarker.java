...
public abstract class LocalMarker implements Marker {
	//------------------------
	//
	// VARIABLES USED FOR LOCAL MARKER
	//
	//------------------------
	...
	public LocalMarker(String id, String title, double latitude, double longitude, double altitude, String link, 
			String signal, int type, int color) {
		super();
	...
	/**
	 * Method for creating the marker screen 
	 * @param originalPoint -  point of origin for the marker
	 * @param viewCam -  camera setting
	 * @param addX - adding to X value
	 * @param addY - adding to Y value 
	 * */
	 ...
	 * @param curGPSFix - current location of user. 
	 * */
	...
	/**
	 * The method will check for the validity of the click.
	 * @param x - x coordinate where by click occurred.
	 * @param y -  y coordinate where by click occurred.
	 * */
	...
	/**
	 * The draw method will call the draw circle and draw text block method. 
	 * @param dw - paint screen instance for drawing onto the AR view.
	 * */
	...
	/** 
	 * Drawing of circle/ markers. This class will be overriden by POIMarker and
	 * NavigationMarker. 
	 * 
	 * @param dw - paint screen instance for drawing onto the AR view.*/
	...
	/** 
	 * Drawing of text block for the markers. This class will be overriden by POIMarker and
	 * NavigationMarker. 
	 * 
	 * @param dw - paint screen instance for drawing onto the AR view.*/
