...
public class AplocActivity extends Activity
{
	Button bnt_aploc;
	...
	public double getlatitude()
	{
		...
		System.out.println(((Math.round(x*1000000))/100000000.0));
		return ((Math.round(x*1000000))/100000000.0);
	}
	...
	public double getlongitude()
	{
		...
		System.out.println(((Math.round(y*1000000))/100000000.0));
		return ((Math.round(y*1000000))/100000000.0);
	}
